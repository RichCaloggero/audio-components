...
const module = class AudioFilter extends _AudioContext_ {
static get template () {
return html`
...
typeChanged (value) {if(this.isReady && value) this.component.type = value;}
frequencyChanged (value) {if (this.isReady && Number(value)) this.component.frequency = value;}
qChanged (value) {if (this.isReady && Number(value)) this.component.q = value;}
gainChanged (value) {if (this.isReady && Number(value)) this.component.gain = value;}
detuneChanged (value) {if (this.isReady && Number(value)) this.component.detune = value;}
} // class AudioFilter
